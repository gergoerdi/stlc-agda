...
-- "Cheating" version: STLC embedded in Agda
...
module Examples where
  ...
  -- With the embedded version of STLC, we can create some Agda functions over these types:
  ...
  open STLC.Typing using (Type; el)

  ⟪A⟫ ⟪B⟫ : Type U
  ⟪A⟫ = el (# 0)
  ⟪B⟫ = el (# 1)

  open STLC.Syntax (Type U)
  module Raw where
